  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        ...
        style={{
          //backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(/src/assets/hero/hero-12)`,
      ...
      <section className="section-padding bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-card p-6 rounded-lg border text-center hover-scale">
              <img 
                src="https://images.unsplash.com/photo-1494790108755-2616c6d85f32?w=300&h=300&fit=crop&crop=face" 
