...
import { BookOpen, DollarSign, Trophy, Users, Calendar, Clock } from "lucide-react";

const CoreAcademic = () => {
  const subPrograms = [
    {
      title: "National Tutoring Program",
      ...
      duration: "Year-round",
      features: ["One-on-one tutoring", "Small group sessions", "Progress tracking", "Parent engagement"]
    },
    {
      title: "Dollars and $ense",
      ...
      features: ["Banking basics", "Budgeting skills", "Investment principles", "Entrepreneurship"]
    },
    {
      ...
      ageGroup: "Ages 5-14",
      duration: "Ongoing",
      features: ["Phonics instruction", "Comprehension strategies", "Cultural literature", "Reading challenges"]
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(/src/assets/programs/academic-programs.jpg)`,
            ...
            {subPrograms.map((program, index) => (
              <div key={index} className="bg-card rounded-lg shadow-lg overflow-hidden">
                <div className="grid lg:grid-cols-2 gap-8 p-8">
                  ...
                  <div className="space-y-6">
                    <h4 className="text-xl font-semibold text-primary">Program Features:</h4>
